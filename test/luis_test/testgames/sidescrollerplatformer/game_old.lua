-- sidescroller.lua
local game = require("gamebase")
local bump = require("bump")
local flux = require("flux")
local tiny = require("tiny")

-- Access world and bump
...
--[[
function love.load()
    require("sidescroller").load()
end

function love.update(dt)
    require("sidescroller").update(dt)
end

function love.draw()
    require("sidescroller").draw(dt)
end

function love.keypressed(key)
    require("sidescroller").keypressed(key)
end
